...
app.get("/", async (req, res) => {
  ...
  await page.goto(
    "https://store.playstation.com/pt-br/category/35027334-375e-423b-b500-0d4d85eff784/1"
  );
  ...
  const data = await page.evaluate(() => {
    ...
    const listOffers = offers.map(item => {
      return {
        ...
        thumb: item.querySelector('img').getAttribute('src').replace("?w=54&thumb=true", ""),
